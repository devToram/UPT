...
import { backend_util, BackendTimingInfo, DataStorage, DataType, KernelBackend, Rank, Scalar, ShapeMap, Tensor, Tensor1D, Tensor2D, Tensor3D, Tensor4D, Tensor5D, TensorInfo } from '@tensorflow/tfjs-core';
interface DataId {
}
...
export declare class MathBackendCPU extends KernelBackend {
    ...
    conv3d(x: Tensor5D, filter: Tensor5D, convInfo: backend_util.Conv3DInfo): Tensor5D;
    conv2dDerInput(dy: Tensor4D, filter: Tensor4D, convInfo: backend_util.Conv2DInfo): Tensor4D;
    conv3dDerInput(dy: Tensor5D, filter: Tensor5D, convInfo: backend_util.Conv3DInfo): Tensor5D;
    conv2dDerFilter(x: Tensor4D, dy: Tensor4D, convInfo: backend_util.Conv2DInfo): Tensor4D;
    conv3dDerFilter(x: Tensor5D, dy: Tensor5D, convInfo: backend_util.Conv3DInfo): Tensor5D;
    ...
    depthwiseConv2D(x: Tensor4D, filter: Tensor4D, convInfo: backend_util.Conv2DInfo): Tensor4D;
    ...
    resizeBilinearBackprop(dy: Tensor4D, x: Tensor4D, alignCorners: boolean): tf.Tensor<tf.Rank.R4>;
    resizeNearestNeighbor(x: Tensor4D, newHeight: number, newWidth: number, alignCorners: boolean): Tensor4D;
    resizeNearestNeighborBackprop(dy: Tensor4D, x: Tensor4D, alignCorners: boolean): tf.Tensor<tf.Rank.R4>;
    ...
    epsilon(): number;
    cropAndResize(images: Tensor4D, boxes: Tensor2D, boxIndex: Tensor1D, cropSize: [number, number], method: string, extrapolationValue: number): tf.Tensor<tf.Rank.R4>;
